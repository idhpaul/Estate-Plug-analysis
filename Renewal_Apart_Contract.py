...
Apart15 = do_ReadContractData(_item="apart", _year=2015, _startMonth=1, _endMonth=12)
print(Apart15)

Apart16 = do_ReadContractData(_item="apart", _year=2016, _startMonth=1, _endMonth=12)
print(Apart16)

Apart17 = do_ReadContractData(_item="apart", _year=2017, _startMonth=1,  _endMonth=12)
print(Apart17)

Apart18 = do_ReadContractData(_item="apart", _year=2018,  _startMonth=1, _endMonth=12)
print(Apart18)

Apart19 = do_ReadContractData(_item="apart", _year=2019,  _startMonth=1, _endMonth=12)
print(Apart19)

Apart20 = do_ReadContractData(_item="apart", _year=2020, _startMonth=1, _endMonth=12)
print(Apart20)


# %%
# 아파트 월 별 거래금액(막대그래프) (userspace)
calc_contract_monthly_price(_data= Apart15, _item= "apart",_year=2015, _startMonth=1, _endMonth=12)
calc_contract_monthly_price(_data= Apart16, _item= "apart", _year=2016, _startMonth=1, _endMonth=12)
calc_contract_monthly_price(_data= Apart17, _item= "apart",_year=2017, _startMonth=1, _endMonth=12)
calc_contract_monthly_price(_data= Apart18, _item= "apart", _year=2018, _startMonth=1, _endMonth=12)
calc_contract_monthly_price(_data= Apart19, _item= "apart",_year=2019, _startMonth=1, _endMonth=12)
calc_contract_monthly_price(_data= Apart20, _item= "apart",_year=2020, _startMonth=1, _endMonth=12)

# %%
# 아파트 월 별 거래 증감률(선형 그래프) (userspace)
calc_contract_monthly_increase(_data= Apart15, _item= "apart",_year=2015, _startMonth=1, _endMonth=12)
calc_contract_monthly_increase(_data= Apart16, _item= "apart",_year=2016, _startMonth=1, _endMonth=12)
calc_contract_monthly_increase(_data= Apart17, _item= "apart",_year=2017, _startMonth=1, _endMonth=12)
calc_contract_monthly_increase(_data= Apart18, _item= "apart",_year=2018, _startMonth=1, _endMonth=12)
calc_contract_monthly_increase(_data= Apart19, _item= "apart",_year=2019, _startMonth=1, _endMonth=12)
calc_contract_monthly_increase(_data= Apart20, _item= "apart",_year=2020, _startMonth=1, _endMonth=12)
# %%
# 아파트 연도 별 거래 증감률(선형 그래프) (userspace)
calc_contract_yearly_increase(_item= "apart", _startYear=2015, _endYear=2020)

#%%
# 아파트 연도 별 거래 비중(원 그래프) (userspace)
calc_contract_yearly_percentage(_item= "apart", _year=2015)
calc_contract_yearly_percentage(_item= "apart", _year=2016)
calc_contract_yearly_percentage(_item= "apart", _year=2017)
calc_contract_yearly_percentage(_item= "apart", _year=2018)
calc_contract_yearly_percentage(_item= "apart", _year=2019)
calc_contract_yearly_percentage(_item= "apart", _year=2020)
