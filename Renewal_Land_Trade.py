...
Land15 = do_ReadData(_item="land", _year=2015, _startMonth=1, _endMonth=12)
print(Land15)

Land16 = do_ReadData(_item="land", _year=2016, _startMonth=1, _endMonth=12)
print(Land16)

Land17 = do_ReadData(_item="land", _year=2017, _startMonth=1, _endMonth=12)
print(Land17)

Land18 = do_ReadData(_item="land", _year=2018, _startMonth=1, _endMonth=12)
print(Land18)

Land19 = do_ReadData(_item="land", _year=2019, _startMonth=1, _endMonth=12)
print(Land19)

# # 01 데이터 누락
# Land20 = do_ReadData(_item="land", _year=2020, _startMonth=1, _endMonth=7)
# print(Land20)
