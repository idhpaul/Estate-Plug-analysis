...
Detached15 = do_ReadTradeData(_item="detached", _year=2015, _startMonth=1, _endMonth=12)
print(Detached15)

Detached16 = do_ReadTradeData(_item="detached", _year=2016, _startMonth=1, _endMonth=12)
print(Detached16)

Detached17 = do_ReadTradeData(_item="detached", _year=2017, _startMonth=1,  _endMonth=12)
print(Detached17)

Detached18 = do_ReadTradeData(_item="detached", _year=2018,  _startMonth=1, _endMonth=12)
print(Detached18)

Detached19 = do_ReadTradeData(_item="detached", _year=2019,  _startMonth=1, _endMonth=12)
print(Detached19)

Detached20 = do_ReadTradeData(_item="detached", _year=2020, _startMonth=1, _endMonth=12)
print(Detached20)


# %%
# 주택 월 별 거래금액(막대그래프) (userspace)
calc_trade_monthly_price(_data= Detached15, _item= "detached",_year=2015, _startMonth=1, _endMonth=12)
calc_trade_monthly_price(_data= Detached16, _item= "detached", _year=2016, _startMonth=1, _endMonth=12)
calc_trade_monthly_price(_data= Detached17, _item= "detached",_year=2017, _startMonth=1, _endMonth=12)
calc_trade_monthly_price(_data= Detached18, _item= "detached", _year=2018, _startMonth=1, _endMonth=12)
calc_trade_monthly_price(_data= Detached19, _item= "detached",_year=2019, _startMonth=1, _endMonth=12)
calc_trade_monthly_price(_data= Detached20, _item= "detached",_year=2020, _startMonth=1, _endMonth=12)

# %%
# 주택 월 별 거래 증감률(선형 그래프) (userspace)
calc_trade_monthly_increase(_data= Detached15, _item= "detached",_year=2015, _startMonth=1, _endMonth=12)
calc_trade_monthly_increase(_data= Detached16, _item= "detached",_year=2016, _startMonth=1, _endMonth=12)
calc_trade_monthly_increase(_data= Detached17, _item= "detached",_year=2017, _startMonth=1, _endMonth=12)
calc_trade_monthly_increase(_data= Detached18, _item= "detached",_year=2018, _startMonth=1, _endMonth=12)
calc_trade_monthly_increase(_data= Detached19, _item= "detached",_year=2019, _startMonth=1, _endMonth=12)
calc_trade_monthly_increase(_data= Detached20, _item= "detached",_year=2020, _startMonth=1, _endMonth=12)
# %%
# 주택 연도 별 거래 증감률(선형 그래프) (userspace)
calc_trade_yearly_increase(_item= "detached", _startYear=2015, _endYear=2020)

#%%
# 주택 연도 별 거래 비중(원 그래프) (userspace)
calc_trade_yearly_percentage(_item= "detached", _year=2015)
calc_trade_yearly_percentage(_item= "detached", _year=2016)
calc_trade_yearly_percentage(_item= "detached", _year=2017)
calc_trade_yearly_percentage(_item= "detached", _year=2018)
calc_trade_yearly_percentage(_item= "detached", _year=2019)
calc_trade_yearly_percentage(_item= "detached", _year=2020)
