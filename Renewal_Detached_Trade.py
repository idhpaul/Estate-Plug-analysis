...
def do_ReadData(_item, _year, _startMonth, _endMonth):
    ...
    return ConcatData
# %%
Detached15 = do_ReadData(_item="detached", _year=2015, _startMonth=1, _endMonth=12)
print(Detached15)

Detached16 = do_ReadData(_item="detached", _year=2016, _startMonth=1, _endMonth=12)
print(Detached16)

Detached17 = do_ReadData(_item="detached", _year=2017, _startMonth=1, _endMonth=12)
print(Detached17)

Detached18 = do_ReadData(_item="detached", _year=2018, _startMonth=1, _endMonth=12)
print(Detached18)

Detached19 = do_ReadData(_item="detached", _year=2019, _startMonth=1, _endMonth=12)
print(Detached19)

Detached20 = do_ReadData(_item="detached", _year=2020, _startMonth=1, _endMonth=7)
print(Detached20)
