...
MultiHouse15 = do_ReadTradeData(_item="multi_housing", _year=2015, _startMonth=1, _endMonth=12)
print(MultiHouse15)

MultiHouse16 = do_ReadTradeData(_item="multi_housing", _year=2016, _startMonth=1, _endMonth=12)
print(MultiHouse16)

MultiHouse17 = do_ReadTradeData(_item="multi_housing", _year=2017, _startMonth=1,  _endMonth=12)
print(MultiHouse17)

MultiHouse18 = do_ReadTradeData(_item="multi_housing", _year=2018,  _startMonth=1, _endMonth=12)
print(MultiHouse18)

MultiHouse19 = do_ReadTradeData(_item="multi_housing", _year=2019,  _startMonth=1, _endMonth=12)
print(MultiHouse19)

MultiHouse20 = do_ReadTradeData(_item="multi_housing", _year=2020, _startMonth=1, _endMonth=12)
print(MultiHouse20)


# %%
# 주택 월 별 거래금액(막대그래프) (userspace)
calc_trade_monthly_price(_data= MultiHouse15, _item= "multi_housing",_year=2015, _startMonth=1, _endMonth=12)
calc_trade_monthly_price(_data= MultiHouse16, _item= "multi_housing", _year=2016, _startMonth=1, _endMonth=12)
calc_trade_monthly_price(_data= MultiHouse17, _item= "multi_housing",_year=2017, _startMonth=1, _endMonth=12)
calc_trade_monthly_price(_data= MultiHouse18, _item= "multi_housing", _year=2018, _startMonth=1, _endMonth=12)
calc_trade_monthly_price(_data= MultiHouse19, _item= "multi_housing",_year=2019, _startMonth=1, _endMonth=12)
calc_trade_monthly_price(_data= MultiHouse20, _item= "multi_housing",_year=2020, _startMonth=1, _endMonth=12)

# %%
# 주택 월 별 거래 증감률(선형 그래프) (userspace)
calc_trade_monthly_increase(_data= MultiHouse15, _item= "multi_housing",_year=2015, _startMonth=1, _endMonth=12)
calc_trade_monthly_increase(_data= MultiHouse16, _item= "multi_housing",_year=2016, _startMonth=1, _endMonth=12)
calc_trade_monthly_increase(_data= MultiHouse17, _item= "multi_housing",_year=2017, _startMonth=1, _endMonth=12)
calc_trade_monthly_increase(_data= MultiHouse18, _item= "multi_housing",_year=2018, _startMonth=1, _endMonth=12)
calc_trade_monthly_increase(_data= MultiHouse19, _item= "multi_housing",_year=2019, _startMonth=1, _endMonth=12)
calc_trade_monthly_increase(_data= MultiHouse20, _item= "multi_housing",_year=2020, _startMonth=1, _endMonth=12)
# %%
# 주택 연도 별 거래 증감률(선형 그래프) (userspace)
calc_trade_yearly_increase(_item= "multi_housing", _startYear=2015, _endYear=2020)