...
def do_ReadData(_item, _year, _startMonth, _endMonth):
    ...
    return ConcatData
# %%
Officetel15 = do_ReadData(_item="officetel", _year=2015, _startMonth=1, _endMonth=12)
print(Officetel15)

# # CHECK : 04 부터 누락
# Officetel16 = do_ReadData(_item="officetel", _year=2016, _startMonth=1, _endMonth=12)
# print(Officetel16)

Officetel17 = do_ReadData(_item="officetel", _year=2017, _startMonth=1, _endMonth=12)
print(Officetel17)

Officetel18 = do_ReadData(_item="officetel", _year=2018, _startMonth=1, _endMonth=12)
print(Officetel18)

Officetel19 = do_ReadData(_item="officetel", _year=2019, _startMonth=1, _endMonth=12)
print(Officetel19)

# # CHECK : 05 부터 누락
# Officetel20 = do_ReadData(_item="officetel", _year=2020, _startMonth=1, _endMonth=7)
# print(Officetel20)