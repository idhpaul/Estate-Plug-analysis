...
def do_ReadData(_item, _year, _startMonth, _endMonth):
    ...
    return ConcatData
# %%
Apart15 = do_ReadData(_item="apart", _year=2015, _startMonth=1, _endMonth=12)
print(Apart15)

Apart16 = do_ReadData(_item="apart", _year=2016, _startMonth=1, _endMonth=12)
print(Apart16)

Apart17 = do_ReadData(_item="apart", _year=2017, _startMonth=1,  _endMonth=12)
print(Apart17)

Apart18 = do_ReadData(_item="apart", _year=2018,  _startMonth=1, _endMonth=12)
print(Apart18)

Apart19 = do_ReadData(_item="apart", _year=2019,  _startMonth=1, _endMonth=12)
print(Apart19)

Apart20 = do_ReadData(_item="apart", _year=2020, _startMonth=1, _endMonth=7)
print(Apart20)
