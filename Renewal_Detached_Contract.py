...
def calc_contract_monthly_increase(_data, _item, _year, _startMonth, _endMonth):
    ...
    target_collection_name = _item + "_contract_monthly_increase"
...
def calc_contract_monthly_price(_data, _item, _year, _startMonth, _endMonth):
    ...
    target_collection_name = _item + "_contract_monthly_price"
...
def calc_contract_yearly_percentage(_item, _year):

    target_collection_name = _item + "_contract_yearly_percentage"

    read_target_trade_data = do_ReadContractData(_item=_item, _year=_year, _startMonth=1, _endMonth=12)
    temp = read_target_trade_data

    if(temp['지역코드'] == Series):
        temp['지역코드'].astype(int)
    else:
    ...
    new_column = temp['보증금액']
    new_column.name = '지역별 거래 비율'

    new_pd = new_column.to_frame()
    new_pd

    hole_count=seoul_temp['보증금액'].count()
    hole_count
...
Detached15 = do_ReadContractData(_item="detached", _year=2015, _startMonth=1, _endMonth=12)
print(Detached15)

Detached16 = do_ReadContractData(_item="detached", _year=2016, _startMonth=1, _endMonth=12)
print(Detached16)

Detached17 = do_ReadContractData(_item="detached", _year=2017, _startMonth=1,  _endMonth=12)
print(Detached17)

Detached18 = do_ReadContractData(_item="detached", _year=2018,  _startMonth=1, _endMonth=12)
print(Detached18)

Detached19 = do_ReadContractData(_item="detached", _year=2019,  _startMonth=1, _endMonth=12)
print(Detached19)

Detached20 = do_ReadContractData(_item="detached", _year=2020, _startMonth=1, _endMonth=12)
print(Detached20)
...
calc_contract_monthly_price(_data= Detached15, _item= "detached",_year=2015, _startMonth=1, _endMonth=12)
calc_contract_monthly_price(_data= Detached16, _item= "detached", _year=2016, _startMonth=1, _endMonth=12)
calc_contract_monthly_price(_data= Detached17, _item= "detached",_year=2017, _startMonth=1, _endMonth=12)
calc_contract_monthly_price(_data= Detached18, _item= "detached", _year=2018, _startMonth=1, _endMonth=12)
calc_contract_monthly_price(_data= Detached19, _item= "detached",_year=2019, _startMonth=1, _endMonth=12)
calc_contract_monthly_price(_data= Detached20, _item= "detached",_year=2020, _startMonth=1, _endMonth=12)

# %%
# 주택 월 별 거래 증감률(선형 그래프) (userspace)
calc_contract_monthly_increase(_data= Detached15, _item= "detached",_year=2015, _startMonth=1, _endMonth=12)
calc_contract_monthly_increase(_data= Detached16, _item= "detached",_year=2016, _startMonth=1, _endMonth=12)
calc_contract_monthly_increase(_data= Detached17, _item= "detached",_year=2017, _startMonth=1, _endMonth=12)
calc_contract_monthly_increase(_data= Detached18, _item= "detached",_year=2018, _startMonth=1, _endMonth=12)
calc_contract_monthly_increase(_data= Detached19, _item= "detached",_year=2019, _startMonth=1, _endMonth=12)
calc_contract_monthly_increase(_data= Detached20, _item= "detached",_year=2020, _startMonth=1, _endMonth=12)
# %%
# 주택 연도 별 거래 증감률(선형 그래프) (userspace)
calc_contract_yearly_increase(_item= "detached", _startYear=2015, _endYear=2020)

# %%
# 주택 연도 별 거래 비중(원 그래프) (userspace)
calc_contract_yearly_percentage(_item= "detached", _year=2015)
calc_contract_yearly_percentage(_item= "detached", _year=2016)
calc_contract_yearly_percentage(_item= "detached", _year=2017)
calc_contract_yearly_percentage(_item= "detached", _year=2018)
calc_contract_yearly_percentage(_item= "detached", _year=2019)
calc_contract_yearly_percentage(_item= "detached", _year=2020)
